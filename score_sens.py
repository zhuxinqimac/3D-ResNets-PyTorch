...
def evaluate(test_loader, model, criterion, val_logger, softmax, 
        analysis_recorder):
...
# ======= Pasted ========
    ...
    # elif args.compared_temp_transform == 'shuffle':
        # temp_transform = Compose([
            # ShuffleFrames(args.sample_duration), 
            # temp_crop_method
        # ])
    # else:
    ...
    with open(analysis_recorder, 'w') as f:
        f.write('')
    evaluate(test_loader, model, criterion, val_logger=val_logger, 
